...
from ..owepaybot import startPrivate
...
class TestStartPrivate:
    ...
    private_message = Message(3, None, Chat(4321234, 'private', username='test,bot', first_name='botname'), from_user=User(5, 'bot', False, username='bota'), text="/start")
    keyboard = [
        [
    ...
    @flaky(3, 1)
    def test_startPrivate(self, privateUpdate):
        massDelete("Users")
        assert isinstance(startPrivate(privateUpdate, contextWithMarkup), Message)
